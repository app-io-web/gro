...
import NotificacoesAlert from '../../components/NotificacoesAlert';  // Importando o componente de notificações
  ...
  return (
    <Flex minH="100vh">
      ...
      <Box
        ...
        ml={{ base: 0, md: '250px' }}
      >
        <NotificacoesAlert />  {/* Componente que verifica e exibe o alerta */}
        <AgendaTecnico />
      </Box>
    </Flex>
  );
